...
def filter_active_advertiser_views(ads_view_path: str, advertiser_path: str) -> pd.DataFrame:
...
def filter_active_advertiser_products(product_view_path: str, advertiser_path: str) -> pd.DataFrame:
    """Filter product logs for active advertisers."""
    product_view = pd.read_csv(product_view_path)
    active_advertisers = pd.read_csv(advertiser_path)
